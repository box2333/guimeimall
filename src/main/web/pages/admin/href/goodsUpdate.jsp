...
<div class="list-content">
    ...
    <div class="block">
        <!--修饰块元素名称-->
        <div class="banner">
            <p class="tab fixed">修改商品</p>
        </div>

        <!--正文内容-->
        <div class="main" style="height: 800px">
            <form id="from" method="post" action="/admin_admin_goodsUpdate" >
                <!--隐藏域id-->
                ...
                <div class="unit clear">
                    ...
                    <div class="right">
                        <input id="goodsName" name="goodsName" type="text" value="${goods.goodsName}" class="text" data-type="必填" error-msg="必填项不能为空" error-pos="42" placeholder="请输入大分类名称" />
                    </div>
                </div>
                ...
                <div class="unit clear">
                    ...
                    <div class="right">
                        <input id="goodsMoney" name="goodsMoney" type="text" value="${goods.goodsMoney}" class="text" data-type="正小数|正整数" error-msg="必填正小数 或 正整数" error-pos="42" placeholder="请输入大分类名称" />
                    </div>
                </div>
                ...
                <div class="unit clear">
                    ...
                    <div class="right">
                        <input id="goodsNumber" name="goodsNumber" type="text" value="${goods.goodsNumber}" class="text" data-type="正整数" error-msg="必填正整数" error-pos="42" placeholder="请输入大分类名称" />
                    </div>
                </div>
                ...
                <div class="unit clear">
                    ...
                    <div class="right">
                        <input id="goodsCarriage" name="goodsCarriage" type="text" value="${goods.goodsCarriage}" class="text" data-type="正整数|正小数" error-msg="必填正小数 或 正整数" error-pos="42" placeholder="请输入大分类名称" />
                    </div>
                </div>
                ...
                <div id="container" class="file-container">
                    <div class="cover">
                        <!--如果不需要回显图片，src留空即可-->
                        <img src="/static/fore/images/${goods.goodsImage}"/>
    ...
    $(function () {
        $.ajax({
            ...
            success: function (small) {
                let smalId = ${goods.goodsSmalId};
                console.log(small);
                $("#select").empty();
                let html = '<option value="">请选择小分类</option>';
                for (let d in small) {
                    if (smalId === small[d].id) {
                        html += '<option value="' + small[d].id + '" selected="selected">' + small[d].smallName + '</option>';
                    } else {
