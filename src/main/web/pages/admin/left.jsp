...
<dl id="leftbox">
    ...
    <dt>订单管理</dt>
    <dd><a href="${pageContext.request.contextPath}/admin_userShow" target="right">订单管理</a></dd>
    <dt>商品详细管理</dt>
    <dd><a href="${pageContext.request.contextPath}/pages/admin/href/goodDetai.jsp" target="right">商品详细管理</a></dd>
    <dt>公告管理</dt>
